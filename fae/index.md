...
<div class="home">
  <div class="fae-hero">
    ...
    <div class="fae-get" id="fae-get">
      ...
      <span class="fae-get-buttons" id="fae-get-buttons"></span>
    </div>
  </div>
    ...
    fetch(API)
      ...
      .then(function(release) {
        ...
        for (var i = 0; i < ORDER.length; i++) {
          ...
          html += '<a href="' + href + '" class="' + cls + '" title="Download for ' + plat.label + '">'
      ...
      .catch(function() {
        ...
        wrap.innerHTML = '<a href="' + href + '" class="fae-os-btn fae-os-active" title="View releases">All platforms</a>';
      });
  }
