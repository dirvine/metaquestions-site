...
4. Four types of ants: harvester, forager, cleaner, soldier
Ants detect patterns by rubbing against each other and change roles based on colony needs.
...
Nodes will delete bad data, self-terminate when infected, sacrifice themselves to save data, or lose data to save the network.
